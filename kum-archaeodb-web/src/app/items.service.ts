...
export class ItemsService {
  ...
  getItems(page: number, size: number, sort: string, order: string): Observable<PageDto> {

    return this.http.get<PageDto>('/api/items?page=' + page + '&size=' + size + '&sort=' + sort + '&order=' + order);
  }
